...
class ProjectService
{
    ...
    public function constructProjectModel($request)
    {
        $projectModel = [
            ...
            'short_description_ar' => $request['short_description_ar'] ?? null,
            'meta_title_en' => $request['metaTitle_en'] ?? null,
            'meta_title_ar' => $request['metaTitle_ar'] ?? null,
            'meta_description_en' => $request['metaDescription_en'] ?? null,
            'meta_description_ar' => $request['metaDescription_ar'] ?? null,
            ...
            'video_link' => $request['videoLink'] ?? null,
